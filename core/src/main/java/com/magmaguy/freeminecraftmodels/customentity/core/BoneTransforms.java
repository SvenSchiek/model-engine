...
import com.unityrealms.server.modelengine.transformation.TransformationMatrix;
...
public class BoneTransforms {
    ...
    public void updateGlobalTransform() {
        if (parent != null) {
            TransformationMatrix.multiply(parent.getBoneTransforms().globalMatrix, localMatrix, globalMatrix);
